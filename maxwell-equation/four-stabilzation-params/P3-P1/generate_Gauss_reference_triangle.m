...
if Gauss_point_number==4
    Gauss_coefficient_reference_triangle=[(1-1/sqrt(3))/8,...
        (1-1/sqrt(3))/8,(1+1/sqrt(3))/8,(1+1/sqrt(3))/8];
...
elseif Gauss_point_number==9
    Gauss_coefficient_reference_triangle=[64/81*(1-0)/8,100/324*(1-sqrt(3/5))/8,...
        100/324*(1-sqrt(3/5))/8,100/324*(1+sqrt(3/5))/8,100/324*(1+sqrt(3/5))/8,...
        40/81*(1-0)/8,40/81*(1-0)/8,40/81*(1-sqrt(3/5))/8,40/81*(1+sqrt(3/5))/8];
