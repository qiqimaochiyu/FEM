...
elseif domain_type==2 %L型区域
    ...
    subplot(2,2,2),contour(x,y,z);xlabel('contour u1');hold on
    subplot(2,2,4),contour(x,y,Z);xlabel('contour u2');hold on
    ...
    subplot(2,2,2),contour(x,y,z);xlabel('contour u1');
    subplot(2,2,4),contour(x,y,Z);xlabel('contour u2');
