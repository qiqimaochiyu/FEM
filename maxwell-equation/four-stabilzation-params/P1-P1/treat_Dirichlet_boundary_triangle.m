function [A,b]=treat_Dirichlet_boundary_triangle(tnp,Dirichlet_boundary_function_name,A,b,boundary_nodes,M)
...
for j=[2 3 4 5 6 8]
    if boundary_nodes(1,k)==-1 
        ...
        A(j*tnp+i,:)=0;
        A(j*tnp+i,j*tnp+i)=1;
        b(j*tnp+i,1)=feval(Dirichlet_boundary_function_name,M(1,i),M(2,i));
    end
