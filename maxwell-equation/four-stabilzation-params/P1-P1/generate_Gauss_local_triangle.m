function [Gauss_coefficient_local_triangle,Gauss_point_local_triangle]=generate_Gauss_local_triangle(vertices_triangle)
%Yu wei 2017-05.
...
global Gauss_coefficient_reference_triangle Gauss_point_reference_triangle

x1=vertices_triangle(1,1);y1=vertices_triangle(2,1);
x2=vertices_triangle(1,2);y2=vertices_triangle(2,2);
x3=vertices_triangle(1,3);y3=vertices_triangle(2,3);
