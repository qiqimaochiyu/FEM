...
number_of_edges=length(b_edges);% 外部边界数
number_of_edges_F=length(Boundary);% 内部边界数
...
uxvxF=assemble_in_line_matrix_plus('a',M,T,T_index,T_plus,tnp,tnp_2,number_of_edges_F,Boundary,1,1,0,1,1,0);
uyvyF=assemble_in_line_matrix_plus('a',M,T,T_index,T_plus,tnp,tnp_2,number_of_edges_F,Boundary,1,0,1,1,0,1);
uxvyF=assemble_in_line_matrix_plus('a',M,T,T_index,T_plus,tnp,tnp_2,number_of_edges_F,Boundary,1,1,0,1,0,1);
uyvxF=assemble_in_line_matrix_plus('a',M,T,T_index,T_plus,tnp,tnp_2,number_of_edges_F,Boundary,1,0,1,1,1,0);
...
[A,k]=treat_Dirichlet_boundary_triangle(tnp,'b',A,k,b_nodes,M);
