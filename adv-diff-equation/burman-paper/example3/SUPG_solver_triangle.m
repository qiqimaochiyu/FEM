function [A,r,F1,F2,F3]=SUPG_solver_triangle(data,mesh_type,left,right,bottom,top,h_1,e,a_1,a_2)
%Yu wei 2018-01
...
B3=assemble_matrix_SUPG(mesh_type,e,h_1,data.a,M,T,T,T,3,3,number_of_elements,matrix_size,G_coe_ref_tri,G_point_ref_tri,0,0,1,0);
B4=assemble_matrix_SUPG(mesh_type,e,h_1,data.a,M,T,T,T,3,3,number_of_elements,matrix_size,G_coe_ref_tri,G_point_ref_tri,0,0,0,1);
...
%     A=b*A3+a_1^2*B1+e*A1+a_2^2*B2+e*A2+a_1*a_2*(B6+B9)+a_1*A4+a_2*A7+a_1*B3+a_2*B4;
%     k=k1+a_1*s2+a_2*s3;
% end

 A=b*A3+a_1^2*B1+e*A1+a_2^2*B2+e*A2+a_1*a_2*(B6+B9)+a_1*A4+a_2*A7;    
 k=k1+a_1*s2+a_2*s3;
