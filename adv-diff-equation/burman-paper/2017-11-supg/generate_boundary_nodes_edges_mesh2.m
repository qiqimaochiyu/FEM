function [boundary_nodes,boundary_edges]=generate_boundary_nodes_edges_mesh2(T_basis,N1_basis,N2_basis,N1_partition,N2_partition)
...
for k=N1_partition+1:N1_partition+N2_partition
    ...
    if T_basis(4,boundary_edges(2,k))==-2
