function r=SUPG_solver_triangle2(data,left,right,bottom,top,h_1,e,a_1,a_2)
...
B1=assemble_matrix_SUPG(mesh_type,e,h_1,data.a,M,T,T,T,number_of_trial_local_basis,number_of_test_local_basis,number_of_elements,matrix_size,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,1,0,1,0);
B2=assemble_matrix_SUPG(mesh_type,e,h_1,data.a,M,T,T,T,number_of_trial_local_basis,number_of_test_local_basis,number_of_elements,matrix_size,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,0,1,0,1);
B6=assemble_matrix_SUPG(mesh_type,e,h_1,data.a,M,T,T,T,number_of_trial_local_basis,number_of_test_local_basis,number_of_elements,matrix_size,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,1,0,0,1);
B9=B6';
...
k2=assemble_vector_SUPG(mesh_type,e,h_1,data.f,M,T,T,number_of_test_local_basis,number_of_elements,vector_size,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,1,0);
k3=assemble_vector_SUPG(mesh_type,e,h_1,data.f,M,T,T,number_of_test_local_basis,number_of_elements,vector_size,Gauss_coefficient_reference_triangle,Gauss_point_reference_triangle,0,1);
